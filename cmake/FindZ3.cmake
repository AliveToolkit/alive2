...
if (CYGWIN)
  ...
  set_property(TARGET Z3::Z3 PROPERTY LINK_FLAGS "-L${Z3_LIB_DIR}")
  set_property(TARGET Z3::Z3 PROPERTY INTERFACE_LINK_LIBRARIES "z3")

  file(COPY "${Z3_LIBRARIES}" DESTINATION "${PROJECT_BINARY_DIR}")
else()
  set_property(TARGET Z3::Z3 PROPERTY INTERFACE_LINK_LIBRARIES "${Z3_LIBRARIES}")
endif()
