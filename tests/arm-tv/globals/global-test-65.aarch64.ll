...
%struct.anon = type { i32, i16, i32, i64, i16, i32, i8, i32 }
...
define zeroext i8 @f(i8 zeroext %0) local_unnamed_addr #0 {
  ...
  %3 = trunc i32 %2 to i8
  %4 = add i8 %3, %0
  store i8 %4, i8* getelementptr inbounds (%struct.anon, %struct.anon* @s, i64 0, i32 6), align 8
  %5 = load i32, i32* getelementptr inbounds (%struct.anon, %struct.anon* @s, i64 0, i32 5), align 4
  %6 = trunc i32 %5 to i8
  %7 = add i8 %4, %6
  %8 = load i16, i16* getelementptr inbounds (%struct.anon, %struct.anon* @s, i64 0, i32 1), align 4
  %9 = trunc i16 %8 to i8
  %10 = add i8 %7, %9
  store i8 %10, i8* getelementptr inbounds (%struct.anon, %struct.anon* @s, i64 0, i32 6), align 8
  ...
  store i32 %18, i32* getelementptr inbounds (%struct.anon, %struct.anon* @s, i64 0, i32 2), align 8
  ret i8 %17
}
