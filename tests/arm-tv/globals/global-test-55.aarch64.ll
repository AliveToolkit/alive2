...
%struct.anon = type { i32, i32, i16, i32, i16, i32, i64, i8 }

@s = common local_unnamed_addr global %struct.anon zeroinitializer, align 8

; Function Attrs: mustprogress nofree norecurse nosync nounwind ssp uwtable willreturn
define i64 @f(i64 %0) local_unnamed_addr #0 {
  %2 = load i32, i32* getelementptr inbounds (%struct.anon, %struct.anon* @s, i64 0, i32 3), align 4
  %3 = zext i32 %2 to i64
  %4 = add i64 %3, %0
  %5 = load i16, i16* getelementptr inbounds (%struct.anon, %struct.anon* @s, i64 0, i32 2), align 8
  %6 = sext i16 %5 to i64
  %7 = add i64 %4, %6
  ...
  store i32 %10, i32* getelementptr inbounds (%struct.anon, %struct.anon* @s, i64 0, i32 0), align 8
  %11 = and i64 %8, 255
  %12 = add i64 %11, %8
  %13 = trunc i64 %12 to i16
  store i16 %13, i16* getelementptr inbounds (%struct.anon, %struct.anon* @s, i64 0, i32 4), align 8
  store i64 %12, i64* getelementptr inbounds (%struct.anon, %struct.anon* @s, i64 0, i32 6), align 8
  %14 = add i64 %12, %3
