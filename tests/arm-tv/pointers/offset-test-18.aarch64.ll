...
%struct.s = type { i8, i32, i16, i16, i64, i32 }
...
entry:
  ...
  store i8 %conv2, ptr %p, align 8
  %f1 = getelementptr inbounds %struct.s, ptr %p, i64 0, i32 1
  store i32 %conv1, ptr %f1, align 4
  %f4 = getelementptr inbounds %struct.s, ptr %p, i64 0, i32 4
  %1 = load i64, ptr %f4, align 8
  %2 = trunc i64 %1 to i32
  %conv12 = shl nuw nsw i32 %conv1, 2
  %add16 = add i32 %conv12, %2
  store i32 %add16, ptr %f1, align 4
  ret void
}
