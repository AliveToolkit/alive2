...
%struct.s = type { i16, i16, i32, i64, i32, i16 }
...
entry:
  ...
  %1 = load i64, ptr %f3, align 8
  %conv8 = zext i16 %0 to i64
  %add9 = add nsw i64 %1, %conv8
  %conv10 = trunc i64 %add9 to i32
  %2 = load i16, ptr %p, align 8
  %conv1140 = zext i16 %2 to i32
  %add12 = add i32 %conv10, %conv1140
  %f2 = getelementptr inbounds %struct.s, ptr %p, i64 0, i32 2
  %3 = load i32, ptr %f2, align 4
  %add13 = add i32 %add12, %3
  %conv17 = trunc i32 %add13 to i16
  store i16 %conv17, ptr %f1, align 2
  ret void
}
