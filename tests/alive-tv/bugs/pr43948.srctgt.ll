...
@arr = global [32 x i32] zeroinitializer, align 16
@var = global i32 zeroinitializer, align 8


define i32 @src() {
  %t0 = load i32, ptr getelementptr inbounds ([32 x i32], ptr @arr, i64 0, i64 0), align 16
  %t1 = load i32, ptr getelementptr inbounds ([32 x i32], ptr @arr, i64 0, i64 1), align 4
  %t2 = load i32, ptr getelementptr inbounds ([32 x i32], ptr @arr, i64 0, i64 2), align 8
  %t3 = load i32, ptr getelementptr inbounds ([32 x i32], ptr @arr, i64 0, i64 3), align 4
  %t4 = load i32, ptr getelementptr inbounds ([32 x i32], ptr @arr, i64 0, i64 4), align 16
  %t5 = load i32, ptr getelementptr inbounds ([32 x i32], ptr @arr, i64 0, i64 5), align 4
  ...
  store i32 %THREE_OR_FOUR, ptr @var, align 8
  ret i32 %t17
}

define i32 @tgt() {
  %1 = load <4 x i32>, ptr bitcast (ptr @arr to ptr), align 16
  %t4 = load i32, ptr getelementptr inbounds ([32 x i32], ptr @arr, i64 0, i64 4), align 16
  %t5 = load i32, ptr getelementptr inbounds ([32 x i32], ptr @arr, i64 0, i64 5), align 4
