...
define void @src(ptr %a, i32 %x, i32 %y, i32 %z, i64 %n) {
entry:
  br label %for.body
...
define void @tgt(ptr %a, i32 %x, i32 %y, i32 %z, i64 %n) {
entry:
  %0 = icmp sgt i64 %n, 2
...
vector.ph:                                        ; preds = %entry
  ...
  %broadcast.splatinsert1 = insertelement <4 x i32> poison, i32 %z, i32 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %9 = getelementptr inbounds i32, ptr %a, i64 %4
  %10 = getelementptr inbounds i32, ptr %a, i64 %5
  %11 = getelementptr inbounds i32, ptr %a, i64 %6
  %12 = getelementptr inbounds i32, ptr %a, i64 -1
  store i32 %x, ptr %8, align 4
  store i32 %x, ptr %9, align 4
  store i32 %x, ptr %10, align 4
  store i32 %x, ptr %11, align 4
  ...
  store <8 x i32> %interleaved.vec, ptr %14, align 4
