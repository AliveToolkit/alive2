...
define void @src(i32 %v0, i32 %v1, i8* %src, <4 x i8>* %dst) {
bb:
...
define void @tgt(i32 %v0, i32 %v1, i8* %src, <4 x i8>* %dst) {
bb:
  %tmp = add nuw i32 %v0, -1
  %tmp1 = add nuw i32 %v1, %tmp
  %tmp2 = zext i32 %tmp1 to i64
  %tmp3 = getelementptr inbounds i8, i8* %src, i64 %tmp2
  %0 = bitcast i8* %tmp3 to <4 x i8>*
  ...
  store <4 x i8> %tmp22, <4 x i8>* %dst, align 4
  ret void
}
