...
for.body.peel:                                    ; preds = %for.body.peel.begin
  %arrayidx.peel = getelementptr inbounds [8 x i32], ptr @a, i64 0, i64 0
  store i32 undef, ptr %arrayidx.peel, align 4
...
for.body.peel2:                                   ; preds = %for.body.peel.next
  %arrayidx.peel3 = getelementptr inbounds [8 x i32], ptr @a, i64 0, i64 %indvars.iv.next.peel
  store i32 undef, ptr %arrayidx.peel3, align 4
...
for.body:                                         ; preds = %entry.peel.newph
  %arrayidx = getelementptr inbounds [8 x i32], ptr @a, i64 0, i64 %indvars.iv.next.peel4
  store i32 undef, ptr %arrayidx, align 4
  store i32 undef, ptr getelementptr inbounds ([8 x i32], ptr @a, i64 0, i64 3), align 4
  store i32 undef, ptr getelementptr inbounds ([8 x i32], ptr @a, i64 0, i64 4), align 4
  store i32 undef, ptr getelementptr inbounds ([8 x i32], ptr @a, i64 0, i64 5), align 4
  store i32 undef, ptr getelementptr inbounds ([8 x i32], ptr @a, i64 0, i64 6), align 4
  store i32 undef, ptr getelementptr inbounds ([8 x i32], ptr @a, i64 0, i64 7), align 4
  store i32 undef, ptr getelementptr inbounds ([8 x i32], ptr @a, i64 1, i64 0), align 4
  store i32 undef, ptr getelementptr ([8 x i32], ptr @a, i64 1, i64 1), align 4
  br label %for.exit
