...
sw.bb7:                                           ; preds = %while.cond2
  %call12 = call i32 @music_play_api(%struct._MUSIC_OP_API_* %4, i32 34, i32 0, i32 24, i8* %6)
  br label %while.cond2.backedge

sw.bb13:                                          ; preds = %while.cond2
  %call18 = call i32 @music_play_api(%struct._MUSIC_OP_API_* %4, i32 35, i32 0, i32 26, i8* %6)
  br label %while.cond2.backedge

sw.default:                                       ; preds = %while.cond2
  %call19 = call i32 @music_play_api(%struct._MUSIC_OP_API_* %4, i32 33, i32 0, i32 22, i8* null)
  br label %while.cond2.backedge
