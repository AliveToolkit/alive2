...
define i32 @src(i8 zeroext %v1, i8 zeroext %v2, i8 zeroext %v3, i8 zeroext %v4, i8* %ptr) {
entry:
  %xor1 = xor i8 0, %v1
  %xor2 = xor i8 0, %v2
  %xor3 = xor i8 0, %v3
...
define i32 @tgt(i8 zeroext %v1, i8 zeroext %v2, i8 zeroext %v3, i8 zeroext %v4, i8* %ptr) {
entry:
