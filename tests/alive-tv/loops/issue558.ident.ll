...
for.cond.i:                                       ; preds = %land.lhs.true, %entry
  %0 = getelementptr inbounds %struct.S0.0.1.2.3.4.13.22.31.44.48.53.54.55.56.58.59.60.66.68.70.74.77.106.107.108.109.110.113.117.118.128.129, ptr %l_819.i.i, i64 0, i32 0
...
func_39.exit.i.i:                                 ; preds = %for.cond1.i.i.i.i
  %l_8191.sroa.0.0.copyload.i.i = load i64, ptr %0, align 1
