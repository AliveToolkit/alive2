...
expr Value::getTypeConstraints(const Function &f) const {
  return getType().getTypeConstraints(f);
}
...
expr AggregateValue::getTypeConstraints(const Function &f) const {
